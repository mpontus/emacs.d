...
(use-package markdown-mode
  ...
  (setq markdown-command
	(format "pandoc -c file://%s --from markdown_github -t html5 --mathjax --highlight-style pygments --standalone"
		(expand-file-name user-emacs-directory "github-pandoc.css"))))
#+END_SRC
