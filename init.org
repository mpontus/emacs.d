...
Add binaries from node_modules to PATH:
...
;; 	    ;; Use TIDE checker to report compile errors
;; 	    (flycheck-add-next-checker 'typescript-tslint 'typescript-tide))

;; (add-hook 'typescript-mode-hook #'setup-typescript-flycheck 'append)
...
(defun tslint-fix-file-and-revert ()
  ...
  (when (eq major-mode 'typescript-mode)
	...
	(progn (tslint-fix-file)
	       (revert-buffer 'ignore-auto 'noconfirm))
      (message "TSLint not found."))))

(with-eval-after-load "typescript-mode"
  (define-key typescript-mode-map (kbd "C-c r") 'tslint-fix-file-and-revert))
#+END_SRC
