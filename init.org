# -*- org-confirm-babel-evaluate: nil; org-adapt-indentation: nil; org-edit-src-content-indentation: 0; org-src-preserve-indentation: t; -*-
...
#+begin_src emacs-lisp
(defhydra hydra-picture-mode (global-map "C-c p")
  "
Picture:
"
...
(defhydra hydra-git-gutter-diff ()
  "C-c g"
  ("n" git-gutter:next-diff)
  ("g" git-gutter:popup-diff)
